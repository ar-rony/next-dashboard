...
export const createInvoice = async (prevState: State,formData: FormData) => {
    const validatedFields = CreateInvoice.safeParse({
      ...
      // If form validation fails, return errors early. othherwise, continue
      ...
      try{
        await sql`
        INSERT INTO invoices ( customer_id, amount, status, date) VALUES ( ${customerId}, ${amoutInCents}, ${status}, ${date})`;
      }catch(error){
